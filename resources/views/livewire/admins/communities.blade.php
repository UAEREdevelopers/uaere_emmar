    ...
    <div class="content">
        <div class="container">
            <div class="page-title">
                <h3 class="text-info">{{ env('APP_NAME') }} Communities</h3>
            </div>
            <div>
            ...
            <div class="box box-primary">
                <div class="box-body">
                    ...
                    <form accept-charset="utf-8" class="shadow rounded p-3" wire:submit.prevent="add_community()">
                        <div class="text-capitalize bg-dark p-2 shadow mb-3 text-center text-lg text-light rounded">
                            {{ __('Add New community') }}</div>
                        <div class="form-group">
                            <label for="Name">Name</label>
                            <input type="text" name="Name" wire:model.lazy="name" placeholder="Enter Community Name"
                                class="form-control" />
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="TagLine" wire:model.lazy="tag_line" placeholder="Enter TagLine"
                                class="form-control" />
                            @error('tag_line')
                                <span class="text-red-500 text-danger text-xs">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="form-group">
                            <label for="TagDesc">Tag Line</label>
                            <input type="text" name="TagDesc" wire:model.lazy="tag_desc" placeholder="Enter Tag Description"
                                class="form-control" />
                            @error('tag_desc')
                                <span class="text-red-500 text-danger text-xs">{{ $message }}</span>
                            @enderror
                        ...
                        <tbody>
                            @forelse ($communities as $community)
                                <tr>
                                    ...
                                    <td>{{ $community->qualification }}</td>
                                    <td>{{ $community->registered ? 'Registered' : 'Not Registered' }}</td>
                                    <td>{{ $community->address }}</td>
                                    <td><img width="100%" height="70px"
                                            src="{{ env('APP_URL') . 'storage/' . $community->photo_path }}"
                                            alt=""></td> -->
                                    <td class="text-right">
